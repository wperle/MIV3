                    ...
                    <form class="form-horizontal" name="formulaire"> 
                        <div class="col-xs-6 col-lg-6">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <input type="text" name="prix" id="ville" maxlength="20" placeholder="Prix" class="form-control modifInput" pattern="^[a-zA-Z0-9]{1,20}$">                       
                            </div>                            
                        </div>
                      ...
                      ?>   
                        <div class="rows">
                            <div class="col-xs-4">
                             <label class="control-label" for="anneeEvaluation">Année d'évalution</label>
                              <input type="text" class="form-control" name="anneeEvaluation" id="anneeEvaluation" placeholder="Année d'évalution">
                            </div>
                            <div class="col-xs-4">
                              <label class="control-label" for="evaluationBatisse">Evaluation de la bâtisse</label>
                              <input type="text" class="form-control" name="evaluationBatisse" id="evaluationBatisse"  placeholder="Evaluation de la batisse">
                            </div>
                            <div class="col-xs-4">
                              <label class="control-label" for="evaluationTerrain">Evaluation du terrain</label>
                    ...
                    <?php } ?>
                            ...
                            <div class="col-xs-12 col-lg-12 well wellForm">
                                <div class="form-group form-inline modifInput">
                                    ...
                                    <textarea name="description" class="form-control" maxlength="1500" placeholder="Description" rows="5" cols="75"><?php // var_dump($_POST)?></textarea>
                                </div>
                            </div>
